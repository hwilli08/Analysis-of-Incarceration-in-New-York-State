...
if not top_10_facilities.empty:
    ...
    plt.xlabel('Top 10 Housing Facilities with the Highest Amount of Incarcerated Individuals in NYS', fontsize=12)
...
if not bottom_10_facilities.empty:
    ...
    plt.xlabel('Bottom 10 Housing Facilities with the Least Amount of Incarcerated Individuals in NYS', fontsize=12)
    plt.ylabel('Number of Incarcerated Individuals', fontsize=12)
    plt.legend(title='Race/Ethnicity')
    plt.xticks(rotation=45, ha='right', fontsize=10)
    #Adding data labels above the bars.
