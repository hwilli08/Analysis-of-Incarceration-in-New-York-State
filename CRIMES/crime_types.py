...
plt.ylabel('NYS Jail, Prison, or Correctional Facility')
plt.xticks(rotation=45, ha='right')
plt.tight_layout()
...
plt.title('Relationship between Crime Category and Top 10 NYS Indicting Counties with Highest Incarceration Rates (2023)')
plt.xlabel('Crime Category')
plt.ylabel('NYS Indicting County')
plt.xticks(rotation=45, ha='right')
plt.tight_layout()
