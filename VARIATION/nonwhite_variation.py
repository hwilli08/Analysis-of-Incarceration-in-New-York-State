...
plt.title('Variation of Percent Non-White Individuals by County of Indictment in NYS (2023)', fontsize=14)
...
plt.title('Variation of Percent Non-White Individuals by NYS Correctional Facility (2023)', fontsize=14)
plt.xticks(fontsize=10)
plt.yticks([])
plt.legend()
plt.grid(axis='x', linestyle='--', alpha=0.7)
