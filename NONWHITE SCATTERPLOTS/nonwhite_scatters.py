...
plt.scatter(facility_counts['Nonwhite_Percentage'], facility_counts['Total_Count'], color='brown', alpha=0.5)
plt.xlabel('% Non-White Individuals', fontsize=12)
plt.ylabel('Number of Incarcerated Individuals', fontsize=12)
plt.title('% Non-White vs. Total # of Incarcerated Individuals by Housing Facility (2023)', fontsize=14)
plt.xticks(fontsize=10)
plt.yticks(fontsize=10)
plt.grid(True)
plt.tight_layout()
plt.savefig('scatterplot_nonwhite_vs_total_by_facility.png')
plt.show()
...
plt.figure(figsize=(10, 6))
plt.scatter(county_counts['Nonwhite_Percentage'], county_counts['Total_Count'], color='brown', alpha=0.5)
plt.xlabel('% Non-White Individuals', fontsize=12)
plt.ylabel('Number of Incarcerated Individuals', fontsize=12)
plt.title('% Non-White vs. Total # of Incarcerated Individuals by County (2023)', fontsize=14)
plt.xticks(fontsize=10)
plt.yticks(fontsize=10)
plt.grid(True)
plt.tight_layout()
plt.savefig('scatterplot_nonwhite_vs_total_by_county.png')
plt.show()
