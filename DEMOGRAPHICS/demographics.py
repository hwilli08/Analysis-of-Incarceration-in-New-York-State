#This script analyzes demographic statistics of incarcerated individuals in New York State for 2023, including age, gender, and race distributions by county of indictment, presenting findings through pie and bar charts.
...
plt.figure(figsize=(10, 7))
race_counts = incarcerated_data_2023['Race/Ethnicity'].value_counts()
colors = ['#8B4513', '#A0522D', '#CD853F', '#D2691E', '#8B5A2B', '#BC8F8F']
bars = plt.bar(race_counts.index, race_counts.values, color=colors)
bars[2].set_color('tan')
...
#Calculating the nonwhite/white percentages.
